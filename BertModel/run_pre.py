...
from model import BertModel, init_tokenizers
from transformers import (get_linear_schedule_with_warmup,
                          RobertaConfig, RobertaTokenizer, AutoModel)
from torch.optim import AdamW
from util import getargs, set_seed, TextDataset
import warnings
...
def main():
    ...
    print("Text model absolute path:", os.path.abspath(args.text_model_path))
    print("Code model absolute path:", os.path.abspath(args.code_model_path))
    init_tokenizers(
